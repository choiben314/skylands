...
//		}
		...
		moveIsland = false;
		moveUp = false;
		gun = new Gun(30, 30, ImagePaths.MISSILE, true, 33);
...
//			}
	...
	public void testSaving() {
		...
		ResourceProducer rp = new ResourceProducer(500, 300, ImagePaths.MISSILE, true, "steel");
		Gun g = new Gun(30, 30, ImagePaths.MISSILE, true, 38);
		Gun g1 = new Gun(50, 50, ImagePaths.MISSILE, true, 89);
		pi.addBuilding(rp);
		pi.addBuilding(g);
		pi.addBuilding(g1);
